...
``To address AI's privacy risks, including potential identification in anonymized data, by developing SURE, an open-source library focusing on evaluating Synthetic Data to preserve utility, privacy, and ensure regulatory compliance.``
